...
*   **Design & UI:** I wanted a modern, sleek look for the app, taking direct inspiration from the **Fey** app UI. Instead of using a big CSS framework, I asked the AI to help me write clean, custom CSS. I tweaked its suggestions to make sure the colors, shadows, and overall feel looked premium.
